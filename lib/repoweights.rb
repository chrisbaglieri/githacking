module RepoWeights
    def get_commits_weight(username, repo)
    ...
    def get_pulls_weight(username, repo)
    ...
    def get_issue_weights(username, repo)
    ...
    def get_collab_weights(username, repo)
    ...
    def get_contrib_weights(username, repo)
